  ...
  <div class="px-6 py-4 md:px-12 md:py-8 text-left">
    ...
    <h3 class="inter-18-700 md:inter-30-700 text-black mt-4">
      ...
      <span v-if="isSuicide" class="text-[#03799A]">
        <NuxtLink to="/dashboard" target="_blank" class="no-underline"> 119 ext. 8 </NuxtLink>
      </span>
      <span v-else class="text-[#03799A]">
        <NuxtLink to="/dashboard" target="_blank" class="no-underline"> Website </NuxtLink>
        <span class="text-black"> atau </span>
        <NuxtLink to="/dashboard" target="_blank" class="no-underline"> WhatsApp </NuxtLink>
      </span>
    </h3>
    ...
    <div v-if="isSuicide">
      ...
      <div class="flex flex-col md:flex-row gap-4 md:justify-between md:items-center mt-4 md:mt-6">
        <NuxtLink to="/dashboard" target="_blank" class="w-full max-w-[17.5rem] relative">
